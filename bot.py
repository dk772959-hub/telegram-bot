...
# │  BOT TOKEN  add karo.   ││
# └──────────────────────────────────────────────────────────────┘
BOT_TOKEN_HARDCODED = "8740654386:AAEnnsYsVyO6IFVGravgsP3DEIwcJ26VdhI"   # ← ADD BOT TOKEN
TOKEN = (
    os.environ.get("8740654386:AAEnnsYsVyO6IFVGravgsP3DEIwcJ26VdhI")
    or os.environ.get("8740654386:AAEnnsYsVyO6IFVGravgsP3DEIwcJ26VdhI")
    or os.environ.get("8740654386:AAEnnsYsVyO6IFVGravgsP3DEIwcJ26VdhI")
    or BOT_TOKEN_HARDCODED
    or ""
).strip()
try:
    OWNER_ID = int(os.environ.get("@BOTT76335", "7603864573"))
...
ANNOUNCE_CHANNEL = os.environ.get("JOIN NOW CHANAL", "").strip()
try:
...
SUPPORT_USR = "@BOTT76335"
UPDATE_CH   = "https://t.me/+C97nuJfmG903Y2Vl"
